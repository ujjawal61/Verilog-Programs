...
set_property PACKAGE_PIN W14 [get_ports {mode[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {mode[0]}]
set_property PACKAGE_PIN W13 [get_ports {mode[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {mode[1]}]
set_property PACKAGE_PIN V2 [get_ports {mode[2]}]					
...
set_property PACKAGE_PIN U14 [get_ports {f_ovf}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f_ovf}]
#set_property PACKAGE_PIN V14 [get_ports {led[7]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led[7]}]
set_property PACKAGE_PIN V13 [get_ports {f_cout}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f_cout}]
